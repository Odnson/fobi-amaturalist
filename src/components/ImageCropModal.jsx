...
function ImageCropModal({ isOpen, onClose, imageUrl, onSave }) {
    ...
    // Reset crop ketika modal dibuka
    useEffect(() => {
        if (isOpen) {
            setCrop(undefined);
            setRotation(0);
    ...
    function centerAspectCrop(mediaWidth, mediaHeight, aspect) {
        // For mobile, use a larger initial crop area for easier handling
    ...
    function getMobileFriendlyCrop(mediaWidth, mediaHeight) {
        // Create a mobile-friendly crop area that's easy to see and adjust
    ...
    function onImageLoad(e) {
        ...
        // Use mobile-friendly crop for both mobile and desktop for better UX
    ...
    const handleSave = async () => {
        try {
            ...
            // Pastikan canvas sesuai dengan crop
            ...
            // Konversi canvas ke blob dengan quality 80%
            ...
            if (useServerCrop) {
                ...
                // Gunakan hasil crop dari browser
                onSave(croppedFile);
            }
        } catch (error) {
