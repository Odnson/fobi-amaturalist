  ...
  const fetchUserData = async () => {
    try {
      ...
      if (data.success) {
        ...
        if (data.data.burungnesia_user_id !== undefined) {
          localStorage.setItem('burungnesia_user_id', data.data.burungnesia_user_id || '');
        }
        if (data.data.kupunesia_user_id !== undefined) {
          localStorage.setItem('kupunesia_user_id', data.data.kupunesia_user_id || '');
        }
        
        console.log('User data synced to localStorage:', {
          burungnesia_user_id: data.data.burungnesia_user_id,
          kupunesia_user_id: data.data.kupunesia_user_id
        });
    ...
    return (
      <div>
        ...
        <div className="mb-4">
          ...
          <Tooltip title="Gunakan password yang sama dengan akun Amaturalist Anda" arrow>
