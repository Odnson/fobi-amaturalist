          ...
          <div className="verification-info">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    ...
                    <span className={`${verificationStatus.fobi ? 'text-green-400' : 'text-amber-400'}`}>
                      Email Amaturalsit: {verificationStatus.fobi ? 'Sudah Terverifikasi' : 'Belum Terverifikasi'}
                    </span>
                  </li>
            ...
            <div className="verification-step bg-[#2c2c2c] border border-[#444] rounded-lg p-4 mb-4">
              ...
              <div className="step-content">
                <h3 className="text-[#e0e0e0]">Email Amaturalist</h3>
                ...
                <div className="step-content">
                  ...
                  {hasBurungnesia && (
                    <div className="integration-item">
                      ...
                      <p className="text-[#b0b0b0]">Email verifikasi Burungnesia akan dikirim setelah verifikasi Amaturalist selesai</p>
                    </div>
                  )}
                  {hasKupunesia && (
                    <div className="integration-item">
                      ...
                      <p className="text-[#b0b0b0]">Email verifikasi Kupunesia akan dikirim setelah verifikasi Amaturalist selesai</p>
                    </div>
                  )}
                </div>
              </div>
