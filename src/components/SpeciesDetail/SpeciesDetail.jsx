...
import { faSpinner, faInfoCircle, faFlag } from '@fortawesome/free-solid-svg-icons';
import toast from 'react-hot-toast';
import TaxaFlagReport from '../TaxaFlagReport';
    ...
    return (
        ...
        <Box sx={{ p: 3, mt: 5 }}>
            <Paper elevation={3} sx={{ p: 3, mb: 3 }}>
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6}>
                        ...
                        {/* Tombol Laporkan Masalah Penamaan */}
                        <Button 
                            variant="outlined" 
                            size="small" 
                            color="warning"
                        ...
                        <ImageList cols={2} gap={8}>
                            {media.map((item, index) => (
                                <ImageListItem key={item.id}>
                                    ...
                                    {item.spectrogram && (
                                        <img
                                            src={getMediaUrl(item.spectrogram)}
            ...
            <TaxaFlagReport
                ...
                taxaId={taxaId}
                taxaName={species?.scientific_name || ''}
                commonName={species?.cname || null}
