    ...
    try {
      ...
      if (response.ok) {
        ...
        if (result.success && result.data) {
          ...
          if (data.burungnesia_user_id !== undefined) {
            localStorage.setItem('burungnesia_user_id', data.burungnesia_user_id || '');
          }
          if (data.kupunesia_user_id !== undefined) {
            localStorage.setItem('kupunesia_user_id', data.kupunesia_user_id || '');
          }
          setUserData(getUserData());
          
          console.log('User data refreshed from /profile:', {
            burungnesia_user_id: data.burungnesia_user_id,
            kupunesia_user_id: data.kupunesia_user_id
          });
        }
      }
    } catch (error) {
