...
import { faMapMarkerAlt, faFlag, faTimes, faExclamationTriangle, faPen, faChevronDown } from '@fortawesome/free-solid-svg-icons';
...
const handleCancelAgreement = async (identificationId) => {
    ...
    return (
        <div className={`${isModal ? '' : 'max-w-7xl mx-auto'} min-h-screen bg-[#121212]`}>
            {/* Tombol close dipindahkan ke parent modal (BantuIdent) */}

            {/* Header Section */}
            <div className={`px-3 sm:px-4 py-4 sm:py-6 md:py-8 border-b border-[#444] bg-[#1e1e1e] ${isModal ? '' : 'mt-12 sm:mt-16'}`}>
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 sm:gap-4">
                        <div className="space-y-2 flex-1 min-w-0">
                            ...
                            <div className="text-gray-300 space-y-1 text-xs sm:text-sm mt-3 sm:mt-4">
                                    ...
                                    <div className="relative">
                                        <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
                                            ...
                                            {canEditObservationLicense && (
                                                <button
                                                    type="button"
                                                    className="ml-1 sm:ml-2 inline-flex items-center px-2 py-1 text-xs rounded-md bg-gray-700 text-gray-200 hover:bg-gray-600 disabled:opacity-60"
                                                    onClick={() => {
                                        ...
                                        {canEditObservationLicense && showLicenseDropdown && (
                                            <div className="absolute z-50 mt-2 w-64 sm:w-80 rounded-md bg-[#1e1e1e] shadow-lg ring-1 ring-[#444] p-2 left-0 sm:left-auto">
                        ...
                        <div className="flex items-center gap-2 flex-wrap mt-2 sm:mt-0">
                            <div className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium shadow-sm
                            ...
                            {checklist?.iucn_status && 
                             ...
                             checklist.iucn_status.trim() !== '' && (
                                (() => {
                                    ...
                                    return (
                                        <div 
                                            className="px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs font-medium shadow-sm text-white"
            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="text-xs sm:text-sm text-gray-300 flex items-center justify-center gap-2 px-2">
                            <FontAwesomeIcon icon={faMapMarkerAlt} className="text-[#1a73e8] flex-shrink-0" />
...
/>
                    ...
                    <div className="space-y-4 sm:space-y-6">
                        ...
                        {/* Tombol Laporkan - dipindah dari header ke bawah TaxaDisplay */}
                        <div className="flex mt-3 sm:mt-4">
                            <button
                                onClick={() => setShowFlagModal(true)}
                                className="inline-flex items-center px-3 sm:px-4 py-2 rounded-lg bg-red-900 text-red-200 hover:bg-red-800 
                                    transition-colors ring-1 ring-red-600/40 text-sm"
                            >
